    ...
    <div className="min-h-screen flex items-center justify-center px-4 gradient-hero relative">
      ...
      <div className="w-full max-w-md relative z-10 animate-scale-in">
        <div className="text-center mb-8">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full glass text-xs text-sky mb-4">
        ...
        <GlassCard neon>
          ...
          <p className="text-center text-sm text-muted-foreground mt-4">
            Need admin access?{" "}
            <Link to="/admin/signup" className="text-primary hover:underline">Register</Link>
          </p>
        </GlassCard>
      </div>
    </div>
